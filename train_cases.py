"""
Training Cases for SnoutNet Models

This file contains 6 training scenarios:
1. SnoutNet on regular dataset
2. SnoutNet on augmented dataset
3. SnoutNetAlexNet on regular dataset
4. SnoutNetAlexNet on augmented dataset
5. SnoutNetVGG16 on regular dataset
6. SnoutNetVGG16 on augmented dataset
...
def train_model(model, model_name, train_file, test_file, img_dir, 
    ...
    run_dir = os.path.join(weights_dir, f'{model_name}{aug_suffix}_{timestamp}')
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_loss < best_val_loss:
            ...
            checkpoint_path = os.path.join(run_dir, f'{model_name}.pt')
            torch.save({
                'epoch': epoch,
